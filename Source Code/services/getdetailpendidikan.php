...
include 'config.php'; 
$id = $_GET['id'];
//$sql = "SELECT id, nama_beasiswa, deadline , deskripsi , pic_normal , array_tag FROM db_beasiswa where id_pendidikan=".$_GET['id'];
//$sql = "SELECT b.id, b.nama_beasiswa, b.deadline , b.pic_normal ,b.univ, b.array_tag, p.nama_pendidikan, n.nama_negara from db_beasiswa b INNER JOIN db_katpendidikan p on b.id_pendidikan = p.id_pendidikan INNER JOIN db_katnegara n on b.id_negara = n.id_negara where b.id_pendidikan=".$_GET['id']; 
// $sql = "SELECT b.id, b.judul_beasiswa, b.deadline , b.pic_normal ,b.univ,b.penyedia, b.jurusan_tag, p.nama_pendidikan, n.nama_negara 
// 		from db_beasiswa b 
// 		INNER JOIN db_katpendidikan p on b.id_pendidikan = p.id_pendidikan 
// 		INNER JOIN db_katnegara n on b.id_negara = n.id_negara 
// 		where b.id_pendidikan=".$_GET['id'];
