...
//   // //$kat = $_GET['kat'];
    ...
    //$result = array(array('domain'=>'','id_domain'=>'','judul'=>'','deadline'=>'','jenjang'=>'','jurusan'=>'','negara'=>'','univ'=>'','konten'=>'','tipe'=>'','penyedia'=>'','openfor'=>'','pick'=>'','picb'=>''));
     $result = array(array('domain'=>'','id_domain'=>'','judul'=>'','deadline'=>'','jenjang'=>'','jurusan'=>'','negara'=>'','negara2'=>'','univ'=>'','konten'=>'','tipe'=>'','penyedia'=>'','openfor'=>'','pick'=>'','picb'=>''));
    ...
    // {
        ...
        //if($this->kat == 'Sarjana')
      {
        ...
        // $url = array();
        // for ($i = 1; $i <= $page; ++$i) {
            //$url = "'http://scholarshipdb.net/scholarships/Category-Scholarship/Program-Undergraduate?q=".$jur."$l=".$neg."&page=" .$page. "&st=listed'";
        ...
        //}
          ...
          $query = "select * from html where url='http://scholarshipdb.net/scholarships/Category-Scholarship/Program-Undergraduate?q=".$jur."$l=".$neg."&page=" .$page. "&st=listed' and xpath='//*[@class=\"col-xs-12 col-sm-9\"]/ul[@class=\"list-unstyled\"]/li/div[1]/h4 | //*[@class=\"col-xs-12 col-sm-9\"]/ul[@class=\"list-unstyled\"]/li/div[2]/*'";
